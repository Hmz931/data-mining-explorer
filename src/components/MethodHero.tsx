...
export const MethodHero = ({ code, tag, title, subtitle }: Props) => (
  <section className="relative border-b border-border bg-gradient-hero overflow-hidden">
    ...
    <div className="container relative py-14 md:py-20">
      <Link
        to="/data-mining"
        className="inline-flex items-center gap-1 text-sm text-accent hover:underline underline-offset-4 mb-6"
      >
      ...
      <h1 className="font-serif text-5xl md:text-6xl font-semibold text-primary leading-[1.02] tracking-tight mb-5 max-w-3xl">
        {title}
      </h1>
      <p className="text-lg text-foreground/75 max-w-2xl leading-relaxed">{subtitle}</p>
    </div>
  </section>
);
